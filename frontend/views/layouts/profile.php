...
<?php $this->beginContent('@frontend/views/layouts/main.php') ?>
    <div class="row">
        ...
        <ul class="nav nav-tabs mb-3">
            ...
            <li class="nav-item"><a class="nav-link <?=Yii::$app->controller->action->id == 'index' ? 'active' : ''; ?>" href="<?= Html::encode(Url::to('/profile/user/index')) ?>"><span class="gl-profile fa fa-file"></span> Posts</a></li>
